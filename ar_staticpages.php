...
$query_page = sprintf("SELECT ArPageContent, ArTitle, BannerImage FROM pages WHERE PageName = %s", GetSQLValueString($colname_page, "text"));
$page = mysql_query($query_page, $conn) or die(mysql_error());
...
<div class="wrapper row3">
  ...
  <figure class="post-image"><img alt="" src="<?php echo $row_page['BannerImage']; ?>"></figure>
          <br/>
      <h1 class="H1-shadow"><?php echo $row_page['ArTitle']; ?></h1>
      <br/>
          <p>   <?php echo $row_page['ArPageContent']; ?> </p>
<br/>                
    </section>
